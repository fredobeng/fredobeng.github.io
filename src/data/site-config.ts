...
const siteConfig: SiteConfig = {
    ...
    hero: {
        ...
        text: "I'm currently studying Medicine in school.\n\n\n In my free time, I play around with Python a lot. I write about what I end up building in <a href='projects'>Projects</a> and use <a href='blog'>Blog</a> as an outlet for my thoughts and experiences.",
        image: {
            src: '/hero.jpg',
